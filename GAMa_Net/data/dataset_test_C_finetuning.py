...
class bdd_vgl_test(Dataset):
    ...
    def __getitem__(self, idx):
        video_name1, start_sec, sat_tile = self.video_list[idx].split(' ')
        
        video_name = video_name1.split('/')[0]
    ...
    def get_list(self):
        ...
        test_list = os.path.join(self.root, 'train_finetuning.list') # video_name/01.jpeg, start_sec, satellite_name
...
class bdd_vgl_gallery(Dataset):
    ...
    def __getitem__(self, idx):
        # required name : video_name/gps.jpeg
        img_name = self.gallery_list[idx].split()[0] ## video_name, start_sec, satellite_name
    ...
    def get_list(self):
        ...
        gallery_list = os.path.join(self.root, 'train_finetuning.list') # # video_name/01.jpeg, start_sec, satellite_name
    ...
    def get_list_1(self):
        ...
        cent_list = os.path.join(self.root, 'dict/dict_centered.json')
