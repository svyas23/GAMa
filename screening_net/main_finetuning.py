...
from data.dataset_finetuning import set_loader
import params
...
def parse_option():
    ...
    parser.add_argument('--trial', type=str, default='4_finetuning',
    ...
    for epoch in range(1, opt.epochs + 1):
        ...
        if epoch % opt.save_freq == 0:
            save_file = os.path.join(
                opt.save_folder, 'finetuned_ckpt_epoch_{epoch}.pth'.format(epoch=epoch))
