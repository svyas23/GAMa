...
class bdd_vgl(Dataset):
    ...
    def get_sample(self, video_name, num_frames):
        ...
        anchor = random.randint(0,5)
        
        if len(aerial_list)>= self.num_frames+anchor:
            #aerial_sq = random.sample(aerial_list, self.num_frames)
            aerial_sq = aerial_list[anchor: anchor+self.num_frames]
        ...
        path=os.path.join(self.root, 'satelite_data/train_gps', video_name1, '00.jpeg')
        ...
        for item in aerial_sq:
            ...
            image_path = os.path.join(self.root, 'satelite_data/train_gps', item1)
    ...
    def get_list(self):
        ...
        #train_list = os.path.join(self.root, mode+'_day_tiny.list') # e.g. 0008a165-c48f4b3e 1202
        train_list = os.path.join('./list', mode+'_day_tiny.list')
    ...
    def get_list_1(self):
        ...
        cent_list = './screening_net/retrieved/dict_centered_train_finetuning.json'
        #cent_list = '/home/c3-0/shruti/data/maps/code_day_unsup_center_aug_Laerial/retrieved/dict_centered_train_finetuning.json'
    ...
    def get_list_2(self):
        ...
        pred_list = './screening_net/retrieved/top_finetuning_pred.json'
